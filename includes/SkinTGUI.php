<?php
/**
 * TGUI - Modern version of MonoBook with fresh look and many usability
 * improvements.
 *
...
/**
 * Skin subclass for TGUI that may be the new or old version of TGUI.
 * IMPORTANT: DO NOT put new code here.
 *
 * @ingroup Skins
 * Skins extending SkinTGUI are not supported
 *
 * @package TGUI
 * @internal
 *
 * @todo
 *  - Move all modern code into SkinTGUI22.
 *  - Move legacy skin code from SkinTGUI to SkinTGUILegacy.
 *  - SkinTGUI left as alias if necessary.
 */
