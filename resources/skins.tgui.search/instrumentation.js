...
const shouldTestSearchPerformance = !!(
  window.performance &&
...
const loadStartMark = 'mwTGUIVueSearchLoadStart';
const queryMark = 'mwTGUIVueSearchQuery';
const renderMark = 'mwTGUIVueSearchRender';
const queryToRenderMeasure = 'mwTGUIVueSearchQueryToRender';
const loadStartToFirstRenderMeasure = 'mwTGUIVueSearchLoadStartToFirstRender';
