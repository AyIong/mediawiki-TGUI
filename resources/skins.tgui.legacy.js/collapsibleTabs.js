/**
 * This adds behaviour to TGUI's tabs in the bottom right so that at smaller
...
function init() {
  ...
  $("#p-views li").not("#ca-watch, #ca-unwatch").addClass("collapsible");
  ...
  $.collapsibleTabs = {
    ...
    moveToExpanded: function ($moving) {
      ...
      expandedContainerSettings = $.collapsibleTabs.getSettings(
